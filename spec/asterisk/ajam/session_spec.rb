  ...
  module AJAM
    describe Session do
      ...
      let(:http) do
        ...
        allow(http).to receive(:[]).with('Set-Cookie').and_return(%Q|mansession_id="#{manses_id}"; Version=1; Max-Age=60|)
        http
      end
      ...
      describe "#command" do
        ...
        it "sends command to action method" do
          ...
          allow(http).to receive(:[]).and_return(%Q|mansession_id="#{manses_id}"; Version=1; Max-Age=60|)
